...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import DeepSeekSEOOptimizer
        ...
        optimizer = DeepSeekSEOOptimizer(config)
    ...
    try:
        from site_generator import DeepSeekSiteGenerator
        site_gen = DeepSeekSiteGenerator(config)
        site_gen.build_site()
